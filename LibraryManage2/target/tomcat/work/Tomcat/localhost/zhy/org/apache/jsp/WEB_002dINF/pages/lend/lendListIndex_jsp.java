 ...
 * Generated at: 2021-04-14 09:28:34 UTC
...
public final class lendListIndex_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    String basePath=request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path+"/";
      ...
      out.write("            {{# if(d.backDate==null){ }}\n");
      out.write("            <a class=\"layui-btn layui-btn-normal layui-btn-xs data-count-edit\" lay-event=\"edit\">异常还书</a>\n");
      ...
      out.write("                    width: 180, title: '书名称'},\n");
      out.write("                {templet: '<div>{{d.reader.cardnumber}}</div>', width: 130, title: '借书卡号'},\n");
      ...
      out.write("                {templet:\"<div>{{layui.util.toDateString(d.lendDate,'yyyy-MM-dd HH:mm:ss')}}</div>\", width: 180, title: '借阅时间'},\n");
      ...
      out.write("                    deleteInfoByIds(data.id,data.bookId,index);\n");
