...
) ENGINE = MyISAM AUTO_INCREMENT = 10 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '���ݿ����Ա��\r\n  ��Ϊ��ͨ����Ա ϵͳ����Ա' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of admin
-- ----------------------------
INSERT INTO `admin` VALUES (9, 'zhyone', 'zhyone', 1);
INSERT INTO `admin` VALUES (2, 'admin', '949949', 0);
...
INSERT INTO `book_info` VALUES (13, 'Java编程思想第4版', '埃克尔 陈昊鹏（译）', '机械工业出版社', '9787111213826', 'Java编程思想 第4版中文版 thinking in java语言程序设计零基础自学 java从入门到精通 核心技术教程教材编程语言JAVA书籍计算机', '中文/英文', 108, '2021-02-11', 28, 1);
...
INSERT INTO `book_info` VALUES (15, '莫泊桑短篇小说集', '莫泊桑', '黑龙江科学技术出版社', '9787538869330', '文学畅销书，小说无数次被改编为戏剧和影视作品风靡全球，北大教授、安徒生文学奖获得者曹文轩倾情推荐。\n[法] 莫泊桑 著', '中文', 43.8, '2021-02-11', 1, 1);
INSERT INTO `book_info` VALUES (16, '溶剂 化工产品手册（第六版）', '解一军 杨宇婴 习峥辉 高晓哲', '化学工业出版社', '9787122263520', '正版 化工产品手册（第六版）溶剂 新版化工产品手册 溶剂产品溶液品种工业技术书 化学工业溶剂与增塑剂的生产工业技术书籍', '中文', 89, '2021-02-11', 4, 0);
...
CREATE TABLE `lend_list`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 21 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '���黹����ؼ�¼��Ϣ' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of lend_list
-- ----------------------------
INSERT INTO `lend_list` VALUES (19, 13, 8, '2021-04-02 11:57:51', NULL, NULL, NULL);
INSERT INTO `lend_list` VALUES (18, 4, 7, '2021-02-12 07:56:40', NULL, NULL, NULL);
INSERT INTO `lend_list` VALUES (20, 15, 8, '2021-04-02 11:57:51', NULL, NULL, NULL);
...
INSERT INTO `notice` VALUES (7, '欢迎再次来到无常图书馆', '2021-04-08', 1);
INSERT INTO `notice` VALUES (8, '我的爱 像尘埃', '2021-04-08', 1);
...
CREATE TABLE `reader_card`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 9 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '���Ŀ���ͼ�鿨��' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of reader_card
-- ----------------------------
INSERT INTO `reader_card` VALUES (8, 'cg', '123456', 6, '程戈', '女', '1997-10-27', NULL, '59763480543', '', NULL, NULL, '1997102727');
INSERT INTO `reader_card` VALUES (2, 'zx', '123456', 6, '张昕', '女', '1995-10-19', NULL, '5678904567890', 'zhangxin@163.com', NULL, NULL, '19951019019');
INSERT INTO `reader_card` VALUES (7, 'qqdd', '123456', 6, '袁一琦', '女', '2000-03-19', NULL, '7896765697', 'yuanyiqi@qq.com', NULL, NULL, '20000319017');
INSERT INTO `reader_card` VALUES (9, 'wyf', '123456', 6, '吴亦凡', '男', '1990-11-06', NULL, '59514268751', '', '2021-04-09 06:13:44', NULL, '1990110606');
