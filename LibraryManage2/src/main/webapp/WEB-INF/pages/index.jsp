                ...
                <li class="layui-nav-item layuimini-setting">
                    ...
                    <dl class="layui-nav-child">
                       <%-- <dd>
                        ...
                        <dd>
                            <a href="javascript:;" layuimini-content-href="pages/user-password.jsp" data-title="修改密码" data-icon="fa fa-gears">修改密码</a>
                        </dd>
                        <dd>
                            <hr>
                        </dd>
...
<script>
    layui.use(['jquery', 'layer', 'miniAdmin','miniTongji'], function () {
        ...
        var options = {
            ...
            iniUrl:"<%=basePath%>api/init2.json",//初始化接口 reader用户进入界面
            </c:when>
            <c:otherwise>
            iniUrl:"<%=basePath%>api/init1.json",//初始化接口 管理员用户进入界面
            </c:otherwise>
            </c:choose>
