    ...
    layui.use(['form', 'table'], function () {
        ...
        table.render({
            ...
            cols: [[
                ...
                {field: 'cardnumber', width: 280, title: '卡号'},
                {field: 'username', width: 210, title: '用户名'},
                //{field: 'name', width: 110, title: '真实姓名'},
                {field: 'sex', width: 120, title: '性别'},
               // {field: 'tel', width: 380, title: '电话'},
                {field: 'number', width: 100, title: '可借数量'},
                {templet:"<div>{{layui.util.toDateString(d.creatDate,'yyyy-MM-dd HH:mm:ss' )}}</div>", width: 956, title: '办卡时间'},
