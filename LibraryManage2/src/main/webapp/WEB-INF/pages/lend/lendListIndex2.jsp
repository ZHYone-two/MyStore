...
<script>
    layui.use(['form', 'table'], function () {
        ...
        table.render({
            ...
            cols: [[
               ...
               // {field: 'id', width: 100, title: 'ID', sort: true},
                {templet: '<div><a href="javascript:void(0)" style="color:#00b7ee" lay-event="bookInfoEvent">{{d.bookInfo.name}}</a></div>',
                    width: 1710, title: '书名称'},
                //{templet: '<div>{{d.reader.cardnumber}}</div>', width: 118, title: '借书卡'},
          ...
          /*      {title:"图书状态",minWidth: 120,templet:function(res){
                        if(res.type=='0'){
        ...
        table.on('tool(currentTableFilter)', function (obj) {
            ...
            if (obj.event === 'edit') {  // 监听添加操作
                ...
                layer.confirm('确认删除吗', function (index) {
                    ...
                    deleteInfoByIds(data.id,data.bookIds,index);
                    layer.close(index);
                });
